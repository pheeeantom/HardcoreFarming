package com.pheeeantom.hardcore_farming.common.block;
...
public class WeedBlock extends BlockBush implements IGrowable, IShearable {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
    	...
    	//p_149691_2_ = (int)Math.floor(Math.random() * 3);
